...
# Runs SDXL batch generation and writes combined stdout/stderr to a timestamped log file.
# Override defaults via environment variables, e.g.:
#   PYTHON_BIN=/venv/main/bin/python DEVICE=cuda:1 ./run_sdxl_batch_logged.sh
#   PYTHON_BIN=/venv/main/bin/python DEVICES="cuda:0 cuda:1" ./run_sdxl_batch_logged.sh

PYTHON_BIN="${PYTHON_BIN:-/venv/main/bin/python}"
BATCH_SCRIPT="${BATCH_SCRIPT:-runs/gradient_sdxl_batch.py}"
PROMPTS_FILE="${PROMPTS_FILE:-prompts/hps_v2_all_eval.txt}"
OUTPUT_ROOT_DIR="${OUTPUT_DIR:-logs/sdxl_batch}"
CONFIG="${CONFIG:-pick}"
...
echo "[INFO] Starting SDXL batch run"
