"""Local SDXL pipeline entry point without SMC/custom latent modifications.

This file keeps a local, editable implementation entry point for future
experimentation, but follows the base SDXL denoising flow.
"""
...
def pipeline_using_stein_sdxl(
    ...
    **kwargs,
    ...
    """Run base SDXL denoising without SMC or latent-space customizations."""
    ...
    latents = cast(torch.Tensor, self.prepare_latents(
    ...
    with self.progress_bar(total=num_inference_steps) as progress_bar:
        for i, t in enumerate(timesteps):
            ...
            latents = cast(
                torch.Tensor,
                self.scheduler.step(noise_pred, t, latents, **extra_step_kwargs, return_dict=False)[0],
            )
