...
def _build_raw_scorer(
    ...
    if normalized == "clip":
        from text2img.scorers.clip_scorer import CLIPScorer
    ...
    if normalized == "pick":
        from text2img.scorers.PickScore_scorer import PickScoreScorer
    ...
    if normalized == "image_reward":
        from text2img.scorers.ImageReward_scorer import ImageRewardScorer
    ...
    if normalized == "aesthetic":
        from text2img.scorers.aesthetic_scorer import AestheticScorer
    ...
    if normalized == "hpsv2":
        from text2img.scorers.hpsv2_scorer import HPSv2Scorer
