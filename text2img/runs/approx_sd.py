...
from text2img.diffusers_patch.pipeline_using_approx_SD import pipeline_using_approx_sd
...
def parse_single_args():
    parser = argparse.ArgumentParser(
        description="Run SD approximate Stein sampling."
    )
    ...
    parser.add_argument("--output-dir", type=str, default="logs/sd_approx", help="Output directory.")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run approx_sd.py over one prompt or prompts from a .txt/.json file.",
    )
