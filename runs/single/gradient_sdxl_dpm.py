...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Detailed SDXL Stein-guided sampling with DPM-Solver and per-step reward traces and plots."
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Optional scheduler eta override (used if supported).",
    )
